...
#
# Usage:
#   ./scripts/sync-sandbox.sh           # latest published release (create-mercato-app@latest)
#   ./scripts/sync-sandbox.sh develop   # newest develop build
#   ./scripts/sync-sandbox.sh 0.4.9-canary-1f829e1484
#   yarn sync:sandbox
#   yarn sync:sandbox 0.4.9-canary-1f829e1484
#
...
backup "data"
backup "storage"
# repo-owned sandbox edits (see docs/adr/0005): module registration and the e2e subject module
backup "src/modules.ts"
backup "src/modules/example_sync"
backup "src/modules/durable_work_sandbox"
