...
export const enabledModules: ModuleEntry[] = [
  ...
  // The two packages this repo develops. `durable_work` is the mechanism; `data_sync`
  // is served by our DROP-IN package instead of core (ADR 0006) — same module id, same
  // tables and API surface, so the swap is this one `from`.
